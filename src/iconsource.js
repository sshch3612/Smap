export default function iconsource(Smap) {
    ...
    Smap.prototype.loadDynamicIconPoint = function ({ id, size = 60, color = "55, 200, 200", imageObj = require("./assets/point0.png"), scale = 1.0 }) {
        const _this = this;
        size = size * scale;
        const gifImage = {
            width: size,
    ...
    Smap.prototype.loadDynamicRotateImg1 = function ({ id, size = 60, color = "55, 200, 200", imageObj = require("./assets/point.png"), scale = 1.0 }) {
        const _this = this;
        size = size * scale;
        const gifImage = {
            width: size,
    ...
    // 
    Smap.prototype.loadDynamicRotateImg = function ({ id, size = 60, color = "55, 200, 200",gif=require("./assets/test.gif"), imageObj = [
        require("./assets/test1.png"), require("./assets/test2.png"), require("./assets/test3.png"),require("./assets/test4.png"),require("./assets/test5.png"),require("./assets/test6.png"), require("./assets/test4.png"), require("./assets/test5.png"), require("./assets/test6.png"), require("./assets/test7.png"), require("./assets/test8.png"), require("./assets/test9.png"), require("./assets/test10.png"),require("./assets/test11.png"),require("./assets/test12.png")],scale = 4.0 }) {
        const _this = this;
        const total = 12;
        size = size * scale;
        const gifImage = {
            ...
            render: function () {
                const duration = 1000;
                const p = (performance.now() % duration) / duration;
                // let t = 1;
                if (this.t == 1) {
                    console.log(this.context, 444);
                }
                const idx = Math.floor(this.t % total) - 1;
                this.img.src = imageObj[idx];
                // const radius = (size / 2) * .5;
                // const outerRadius = (size / 2) * 0.4 + radius;
                const context = this.context;
